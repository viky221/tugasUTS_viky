...
<body id="home">
	...
	<header>
		...
		<section id="main-content">
			<div id="featured">
				<h3>NAMA :</h3>
				<p>ADHI VIKY SUDIANTORO <br/></p>
			</div> <!-- END Featured -->
			<hr/>
			<div id="latest">
				<section class="left-col">
					<h3>FITUR  :</h3><br/>
					<p></p>o> UPLOAD FILE<br/>
					<p></p>o> CARI KATA DASAR<br/>
					<p></p>o> QUERY<br/>
					<p></p>o> HITUNG BOBOT<br/>
					<p></p>o> QUERY 2<br/>
					<p></p>o> HITUNG VEKTOR<br/>
				</section> <!-- END Left Column -->	

				<aside class="sidebar">
					<h4><a href="#">Arsip</a></h4>
					<ul>
						<li><a href="#">April 17 2017</a></li>
					</ul>
					<br/>
			...
			<hr/>
			<div id="about">
				<h3>Tentang Carikata.ga</h3>
				<p>Web ini untuk melengkapi tugas UTS matakuliah informasi retrival</p>
			</div>	
		</section>	
		<hr/>
		<footer>
			<p>&copy; 2017 - Carikata.ga</p>
		</footer>		
	</div> <!-- END Wrapper -->
